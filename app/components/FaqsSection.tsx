              ...
              <div className="heading fw-6 wow fadeInUp" data-wow-delay="0.1s">
                <span className="fw-4 fst-italic font-playfair-display animationtext letters rotate-3">
                  <span className="cd-words-wrapper">
                    <span className="item-text is-visible"><i className="in">G</i><i className="in">o</i><i className="in">t</i><i className="in">&nbsp;</i><i className="in">q</i><i className="in">u</i><i className="in">e</i><i className="in">s</i><i className="in">t</i><i className="in">i</i><i className="in">o</i><i className="in">n</i><i className="in">s</i><i className="in">?</i></span>
                    <span className="item-text is-hidden"><i className="in">G</i><i className="in">o</i><i className="in">t</i><i className="in">&nbsp;</i><i className="in">q</i><i className="in">u</i><i className="in">e</i><i className="in">s</i><i className="in">t</i><i className="in">i</i><i className="in">o</i><i className="in">n</i><i className="in">s</i><i className="in">?</i></span>
